<h2><a href="https://www.geeksforgeeks.org/problems/shortest-job-first/1?page=2&difficulty=Medium&status=unsolved&sortBy=accuracy">Shortest Job first</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Geek is a software engineer. He is assigned with the task of calculating <strong>average waiting time</strong> of all the processes by following <strong>shortest job first</strong> policy.</span></p>
