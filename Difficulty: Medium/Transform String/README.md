<h2><a href="https://www.geeksforgeeks.org/problems/transform-string5648/1?page=1&category=Hash&difficulty=Medium&status=unsolved&sortBy=submissions">Transform String</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given two strings A and B. Find the minimum number of steps required to transform string A into string B. The only allowed operation for the transformation is selecting a character from string A and inserting it in the beginning of string A.</span></p>
