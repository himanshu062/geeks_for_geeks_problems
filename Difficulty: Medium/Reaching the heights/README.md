<h2><a href="https://www.geeksforgeeks.org/problems/reaching-the-heights1921/1?page=7&difficulty=Medium&status=unsolved&sortBy=submissions">Reaching the heights</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">The teacher gives a mental ability question to Raju. The question is as follows:-</span></p>
...
</div><br><p><span style=font-size:18px><strong>Topic Tags : </strong><br><code>Arrays</code>&nbsp;<code>Sorting</code>&nbsp;<code>Misc</code>&nbsp;<code>Data Structures</code>&nbsp;<code>Algorithms</code>&nbsp;